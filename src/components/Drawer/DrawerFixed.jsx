...
export default function PersistentDrawerLeft(props) {
    ...
    return (
        <div className={classes.root}>
            ...
            >
                <div className={classes.drawerHeader} onClick={handleDrawerClose} style={{textAlign: `center`}}>
                    <div  style={{textAlign: `center`, paddingTop:`10px`, paddingRight:`50px`}}>
                        <FaceIcon color={'primary'} fontSize={'large'}/> <div style={{paddingBottom:`10px`}}>Face Shield Controls</div>
                    </div>
                    <IconButton >
